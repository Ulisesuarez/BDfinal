<template>
  <div class="example-full">
    ...
    <h1 id="example-title" class="example-title">Upload a File</h1>
      ...
      <div class="table-responsive">
        <table class="table table-hover">
          ...
          <tr v-for="(file, index) in files" :key="file.id">
            ...
            <td id="columnaDescripcion">
              <v-text-field id="inputDesc" v-model="fileDescription"/>
            </td>
            <td>
              <select v-model="fileTable">
            ...
            <td>
              <div class="btn-group">
                <button @click="subirArchivo()" class="btn btn-secondary btn-sm dropdown-toggle" type="button">
                  Upload
                </button>
      ...
      <div class="form-group">
        ...
        <div class="form-check">
          <label class="form-check-label">
            <input class="form-check-input" type="radio" name="put-action" id="put-action0" value="" v-model="putAction"> Off
          </label>
        </div>
        <div class="form-check">
          <label class="form-check-label">
        ...
        <div class="modal-content">
          ...
          <form @submit.prevent="onEditorFile">
            <div class="modal-body">
              <div class="form-group">
                <label for="name">Name:</label>
                <input type="text" class="form-control" required id="Filename"  placeholder="Please enter a file name" v-model="editFile.name">
              </div>
...
export default {
  ...
  beforeCreate () {
    ...
    this.$http.get('http://localhost:8088/MedicalDB/filelastid').then(response => {
  ...
  methods: {
    subirArchivo () {
      ...
      this.file_id = this.file_id + 1
      this.$http.post(`http://localhost:8088/MedicalDB/uploadFile` +
      '?type=' + this.fileTable +
      '&file_id=' + this.file_id.toString() +
        '&name=' + name +
        '&description=' + this.fileDescription +
        '&account_owner_id=' + this.accountId, {
        headers: {
